...
def save_joints():
    joint_data_fn = 'mpii/data.json'
    mat = loadmat('mpii/mpii_human_pose_v1_u12_1.mat')
...
def split_train_test():
    fp_test = open('mpii/test_joints.csv', 'w')
    fp_train = open('mpii/train_joints.csv', 'w')
    all_data = open('mpii/data.json').readlines()
    N = len(all_data)
    N_test = int(N * 0.1)
    N_train = N - N_test
